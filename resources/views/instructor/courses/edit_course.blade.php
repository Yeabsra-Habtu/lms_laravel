                ...
                <form id="myForm" action="{{ route('store.course') }}" method="POST" class="row g-3"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="certeficate" class="form-select mb-3" aria-label="Default select example">
                            <option selected="" disabled>Open this select menu</option>
                            <option value="Yes" {{ $course->certeficate == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ $course->certeficate == 'No' ? 'selected' : '' }}>No</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="level" class="form-select mb-3" aria-label="Default select example">
                            <option selected="" disabled>Open this select menu</option>
                            <option value="Begginer" {{ $course->level == 'Begginer' ? 'selected' : '' }}>Begginer</option>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="resources" value="{{ $course->resources }}">
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" value="1" name="featured" type="checkbox"
                                    value="" id="flexCheckDefault" {{ $course->featured == '1' ? 'checked' : '' }}>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update.course.video') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <video src="{{ asset($course->video) }}" width="300" height="130" controls>
                                {{-- <source src=  type="video/mp4, video/webm"> --}}
                            </video>
                        </div>
                    </div>
                    <br><br>
