...
<div class="media media-card align-items-center">
    <div class="media-img media--img media-img-md rounded-full">
        <img src="{{ !empty($profileData->photo) ? url('uploads/user_images/' . $profileData->photo) : url('uploads/no_image.jpg') }}"
    ...
    <div class="setting-body">
        ...
        <div class="media media-card align-items-center">
            <div class="media-img media-img-lg mr-4 bg-gray">
                <img class="mr-3" src="{{ !empty($profileData->photo) ? url('uploads/user_images/' . $profileData->photo) : url('uploads/no_image.jpg') }}" alt="avatar image">
            </div>
            <div class="media-body">
