                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('instructor.register') }}"  class="row">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('phone') is-invalid @enderror" type="text" name="phone" placeholder="e.g. 09123456789">
                                    <span class="la la-user input-icon"></span>
                                    @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('adress') is-invalid @enderror" type="text" name="address" placeholder="e.g. Alex">
                                    <span class="la la-user input-icon"></span>
                                    @error('adress')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
